...
[`@aws-sdk/client-secrets-manager`](https://www.npmjs.com/package/@aws-sdk/client-secrets-manager/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IOpblqIdl2rogrHfslPutR5e03zTTP0eXzxOFs55+LdmMRq0wYjKt2ZRtkUY+yFM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-secrets-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.799.0/index.min.mjs": "sha384-IOpblqIdl2rogrHfslPutR5e03zTTP0eXzxOFs55+LdmMRq0wYjKt2ZRtkUY+yFM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-secrets-manager/blob/refs/tags/3.799.0/LICENSE
```
