...
[`@aws-sdk/client-secrets-manager`](https://www.npmjs.com/package/@aws-sdk/client-secrets-manager/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7+GTh3nIAZmZzvnLY6x+7hZJNJVq0paNlo03muy+hx+FCeL2hdehScYQvTkAvEsL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-secrets-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-secrets-manager@3.224.0/index.min.mjs": "sha384-7+GTh3nIAZmZzvnLY6x+7hZJNJVq0paNlo03muy+hx+FCeL2hdehScYQvTkAvEsL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-secrets-manager/blob/refs/tags/3.224.0/LICENSE
```
